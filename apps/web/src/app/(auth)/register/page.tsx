      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold">Bostonia</span>
          </Link>
          <h1 className="text-2xl font-semibold">Create an account</h1>
          <p className="text-muted-foreground mt-2">
            Join Bostonia and start chatting with AI characters
          </p>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg border border-border hover:bg-muted transition-colors"
              >
